...
class PhysicsEngine2DSystem : public Core::ECS::ISystem
{
  public:
    ...
    static CollisionData OverlapPoint(const Core::TransformComponent& transform, const Collider2DComponent& collider,
                                      const glm::vec2& point);
    static CollisionData Overlap(const Core::TransformComponent& transformA, const Collider2DComponent& colliderA,
                                 const Core::TransformComponent& transformB, const Collider2DComponent& colliderB);
  ...
  private:
    ...
    inline static CollisionData OverlapCircle(const glm::vec2& centerA, float radiusA, const glm::vec2& centerB,
                                              float radiusB);
    inline static CollisionData OverlapAABB(const glm::vec2& minA, const glm::vec2& maxA, const glm::vec2& minB,
                                            const glm::vec2& maxB);
    inline static CollisionData OverlapCircleAABB(const glm::vec2& center, float radius, const glm::vec2& minA,
                                                  const glm::vec2& maxA);

    static glm::vec2 GetMin(const Core::TransformComponent& transform)
    {
        return transform.Position - transform.Scale / 2.0f;
    }
    static glm::vec2 GetMax(const Core::TransformComponent& transform)
    {
        return transform.Position + transform.Scale / 2.0f;
    }
...
class PhysicsEngine2DDebugGizmos : public Core::ECS::ISystem
{
public:
...
inline CollisionData PhysicsEngine2DSystem::Overlap(const Core::TransformComponent& transformA,
                                                    const Collider2DComponent& colliderA,
                                                    const Core::TransformComponent& transformB,
                                                    const Collider2DComponent& colliderB)
{
    ...
    {
        auto result =
            OverlapCircleAABB(transformB.Position, GetRadius(transformB), GetMin(transformA), GetMax(transformA));
...
inline CollisionData PhysicsEngine2DSystem::OverlapPoint(const Core::TransformComponent& transform,
                                                         const Collider2DComponent& collider, const glm::vec2& point)
{
